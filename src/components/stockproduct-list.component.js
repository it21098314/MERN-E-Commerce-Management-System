...
import StockTableRowProduct from './StockTableRowProduct'// need to change
import "./pro.css"; 
...
export default class StockList extends Component {
  ...
  DataTable() {
    return this.state.returns.map((res, i) => {
      return <StockTableRowProduct obj={res} key={i} />;
    });
  }
  ...
  render() {
    return (<div className="table-wrapper">
      ...
      <br></br>
      <br></br>
      <h2><i class="fas fa-graduation-cap"></i>&nbsp;Stock Details List</h2><br/>
